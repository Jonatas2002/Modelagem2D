...
refletividades = []
for i in range(nx):
    refletividade = reflectivity(VP[:, i], RHOB[:, i])
...
interfacex = np.zeros(len(refletividade[0]))

for distance in range(len(refletividade[0])):
    for i in range(len(refletividade)):
        if refletividade[i, distance] != 0:
            interfacey = i * dx
            break  
    interfacex[distance] = interfacey + 1

print('int = ', interfacex)
#-------------------------------------------------------------------------------------#
#-------------------------------------------------------------------------------------#
